...
<div class="container col-md-9 col-sm-11 rounded-0">
    <div class="col-12 rounded p-4 mt-4 d-md-flex gap-5">
        <div class="col-md-4 col-sm-12 d-flex justify-content-center mx-auto align-items-start">
            <div class="px-md-5"></div><img src="assets/images/profile/<?= $profile['profile_pic'] ?>" class="img-thumbnail rounded-circle mb-3" style="width:170px;height:170px" alt="...">
        </div>
                    ...
                    ?>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#chatbox" onclick="popchat(<?= $profile['id'] ?>)">
                                        <i class="bi bi-chat-fill"></i> Message</a></li>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body d-flex p-0">
                            ...
                            <div class="col-4 d-flex flex-column">
                                ...
                                <div class="flex-fill align-self-stretch overflow-auto" id="comment-section<?= $post['id'] ?>" height: 100px;">

                                    <?php
                                    $comments = getComment($post['id']);
                                    if (count($comments) < 1) {
                                    ?>
                                        <p class="p-3 text-center my-2 nce">No one is Commented on this post yet</p>
                                    <?php
                                    }
                                    ...
                                    ?>
                                        <div class="d-flex align-items-center p-2">
                                            ...
                                            <div class="d-flex flex-column justify-content-start align-items-start">
                                                <h6 style="margin: 0px;"><a href="?u=<?= $cuser['username'] ?>" class="text-decoration-none text-muted">@<?= $cuser['username'] ?></a></h6>
...
<!-- this is for to show  follower list (on profile page) -->
...
<!-- this is for following list (on profile page) -->
