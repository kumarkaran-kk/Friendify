        ...
        <form method="post" action="assets/php/actions.php?signup">
            ...
            <div class="d-flex gap-3 my-3">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="gender" id="exampleRadios1" value="1" <?= (!isset($_SESSION['formdata']) || showFormData('gender') == 1) ? 'checked' : '' ?>>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="gender" id="exampleRadios2" value="0" <?= (showFormData('gender') == 0 && isset($_SESSION['formdata'])) ? 'checked' : '' ?>>
