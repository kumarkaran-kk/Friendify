...
function checkAdminUser($login_data)
{
    ...
    $password = trim($login_data['password']); // Trim the password

    $query = "SELECT id, ad_password FROM admin WHERE email='$email'";
...
function updateAdmin($data)
{
    ...
    $query = "UPDATE admin SET full_name='$full_name',email='$email',ad_password='$password',password_text='$password_text' WHERE id=$user_id";
    return mysqli_query($db, $query);
}
