...
<head>
    ...
    <title>Pictogram Admin-Dashboard</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="../assets/images/pictogram.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2024 <a href="https://karankr.netlify.app" target="_blank">Kumar Pvt Ltd</a>.</strong>
            All rights reserved.
